...
<?php if ($options['switch-responsive'] == 1) { ?>
	...
	date_default_timezone_set($offset);
		...
		<link rel="stylesheet" href="/wp-content/themes/NativeChurch/css/jquery.fancybox.css?v=2.1.5" type="text/css" media="screen" />
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-8 col-sm-6 col-xs-4">							
								<div id="telephone">
									<p class="p_telephone">+7 914 711 28 20</p>	
									<a class="question" href="#">Форма для связи</a>
									<a class="tel" href="#">Обратный звонок</a>								
								</div>                            	
...
<?php if (!empty($menu_locations['primary-menu'])) { ?>
	...
	<?php wp_nav_menu(array('theme_location' => 'primary-menu', 'menu_class' => 'sf-menu', 'container' => '', 'walker' => new imic_mega_menu_walker)); ?>
			...
			<?php } ?>
				<?php 
					$home_id = get_the_ID();
					if($home_id == 503) {echo '<div id="bread_c">&nbsp;</div>';} 
				?>
			</header>
			<!-- End Site Header -->
			<?php
