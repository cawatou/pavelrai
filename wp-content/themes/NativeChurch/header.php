...
//                <!-- Start Top Row -->
    ...
    <header class="site-header">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-8">
                        <p class="header_text">
                            <span>Изготовление памятников,</span><br>
                            <span>их установка/монтаж и другие</span><br>
                    ...
                    <div class="col-md-8 col-sm-6 col-xs-4">
                        <div class="col-md-4 header_contacts">
                            ...
                            <a class="email" href="mailto:7pavel7@mail.ru">7pavel7@mail.ru</a>
                        </div>
        ...
        <?php if (!empty($menu_locations['primary-menu'])) { ?>
            <div id="undefined-sticky-wrapper" class="sticky-wrapper" style="height: 1px;">
                            ...
                            <div class="gallery-filter">
                                <ul class="nav nav-pills sort-source" data-sort-id="gallery" data-option-key="filter">
                                    ...
                                    <li data-option-value="*" class="active"><a href="#"><i class="fa fa-th"></i>
                                            <span><?php _e('Show All', 'framework'); ?></span></a></li>
                                    <?php foreach ($gallery_cats as $gallery_cat) { ?>
                                        <li data-option-value=".format-<?php echo $gallery_cat->slug; ?>"><a href="#"><i
                                                    class="fa <?php echo $gallery_cat->description; ?>"></i>
